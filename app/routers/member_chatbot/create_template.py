...
weather_forecaster = {
    ...
    "description": "Provides real-time weather forecasts for a specific location in Korea between the given start and end dates.",
    "parameters": {
        "type": "object",
        "properties": {
            "weather_dates": {
                ...
                "properties": {
                    "start_date": {
                        "type": "datetime",
                        "description": "Starting date for the weather information, e.g., 20231010",
                        "format": "%yyyymmdd"
                    },
                    "end_date": {
                        "type": "datetime",
                        "description": "Ending date for the weather information, e.g., 20231020",
                        "format": "%yyyymmdd"
                    }
                },
                "required": ["start_date" ]
            ...
            "location": {
                "type": "string",
                "description": "Specific location for the weather information in Korea"
            },
...
blog_searcher = {
    "name": "blog_searcher",
    "description": "Searches and retrieves travel destination reviews and experiences from various blogs based on the provided query.",
    "parameters": {
        "type": "object",
        "properties": {
            "query": {
...
tools = [travel_info_collector, travel_destination_retriever, weather_forecaster, blog_searcher, travel_itinerary_generator]
